...
void main() {
  testWidgets('opens SSH profiles page from add connection menu', (tester) async {
  ...
  testWidgets('creates local terminals from add connection menu', (tester) async {
    await tester.pumpWidget(const MaterialApp(home: WorkbenchPage()));
  ...
  testWidgets('returns to terminal mode when local terminal is created from SSH page', (
    tester,
  ) async {
    await tester.pumpWidget(const MaterialApp(home: WorkbenchPage()));
